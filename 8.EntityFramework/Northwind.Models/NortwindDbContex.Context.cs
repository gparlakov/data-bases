...
namespace Northwind.Models
{
    ...
    public partial class NorthwindDb : DbContext
    {
        ...
        [EdmFunction("NorthwindDb", "ProductsUnderThisUnitPrice")]
        public virtual IQueryable<ProductsUnderThisUnitPrice_Result> ProductsUnderThisUnitPrice(Nullable<decimal> price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ProductsUnderThisUnitPrice_Result>("[NorthwindDb].[ProductsUnderThisUnitPrice](@price)", priceParameter);
        }
